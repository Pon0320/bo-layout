...
function EditPopover({ slotData, allCategories, isEditMode, onAssignmentChange, onSlotSizeChange, onDeleteSlot, onClose, gridSize }) {
  const { id, name, position, size, assignedCategory, type } = slotData;
